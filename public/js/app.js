...
counterApp.controller('divHideController', ['$scope', function($scope) {
 ...
    };
    ...
    $scope.mattsInfo = function(){
      ...
      $scope.favResources = ["Codecademy", "FreeCodeCamp", "FrontEnd Masters", "w3 Schools", "YouTube", "anybody with experience", "MDN", "Google"];
    ...
    $scope.andysInfo = function(){
      $scope.forDaBorders = "pageThreeAboutMeBottom";
